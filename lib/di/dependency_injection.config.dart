...
import '../core/categories/src/application/save_sub_categories.dart' as _i91;
...
import '../core/transactions/application.dart' as _i72;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i71.TransactionsScreenCubit>(() => _i71.TransactionsScreenCubit(
      get<_i72.GetTransactions>(),
      get<_i12.GetProfileInfo>(),
      get<_i72.AddTransaction>()));
  ...
  gh.factory<_i77.UpdateTransaction>(() => _i77.UpdateTransaction(
      get<_i67.TransactionRepository>(), get<_i72.GetTransactions>()));
  gh.lazySingleton<_i78.UserFirebaseProv>(() => _i78.UserFirebaseProv(
      get<_i46.FirebaseStorage>(), get<_i45.FirebaseFirestore>()));
  gh.factory<_i79.AddTransaction>(
      () => _i79.AddTransaction(get<_i67.TransactionRepository>()));
  ...
  gh.factory<_i83.CreateSubCategory>(
      () => _i83.CreateSubCategory(get<_i31.SubCategoryRepository>()));
  gh.factory<_i84.CreateUser>(() => _i84.CreateUser(get<_i80.AuthService>()));
  gh.factory<_i85.DeleteSubCategory>(
      () => _i85.DeleteSubCategory(get<_i31.SubCategoryRepository>()));
  gh.factory<_i86.DeleteTransaction>(
      () => _i86.DeleteTransaction(get<_i67.TransactionRepository>()));
  gh.factory<_i87.GetProfileInfo>(
      () => _i87.GetProfileInfo(get<_i80.AuthService>()));
  gh.factory<_i88.GetSubCategories>(
      () => _i88.GetSubCategories(get<_i31.SubCategoryRepository>()));
  gh.factory<_i89.GetTransactions>(
      () => _i89.GetTransactions(get<_i67.TransactionRepository>()));
  gh.factory<_i90.LogOut>(() => _i90.LogOut(get<_i80.AuthService>()));
  gh.factory<_i91.SaveSubCategories>(
      () => _i91.SaveSubCategories(get<_i31.SubCategoryRepository>()));
