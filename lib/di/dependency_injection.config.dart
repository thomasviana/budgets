...
import '../core/accounts/src/application/create_account.dart' as _i34;
import '../core/accounts/src/application/delete_account.dart' as _i37;
...
import '../core/budgets/src/application/create_budget.dart' as _i35;
import '../core/budgets/src/application/delete_budget.dart' as _i38;
...
import '../core/categories/domain.dart' as _i32;
import '../core/categories/infrastructure.dart' as _i26;
import '../core/categories/src/application/create_category.dart' as _i36;
...
import '../core/transactions/application.dart' as _i78;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i25.BudgetsScreenCubit>(() => _i25.BudgetsScreenCubit(
      get<_i24.GetBudgets>(),
      get<_i12.GetProfileInfo>(),
      get<_i24.CreateBudget>(),
      get<_i24.SaveBudgets>()));
  gh.lazySingleton<_i26.CategoriesDatabase>(
      () => dbInjectableModule.categoriesDatabase);
  gh.lazySingleton<_i27.CategoriesLocalDataSource>(() =>
      _i27.CategoriesLocalDataSourceImpl(
          get<_i26.CategoryDao>(),
          get<_i26.SubCategoryDao>(),
          get<_i26.CategoryMapper>(),
          get<_i26.SubCategoryMapper>()));
  gh.factory<_i28.CategoriesScreenCubit>(() => _i28.CategoriesScreenCubit(
      get<_i14.GetCategories>(),
      get<_i12.GetProfileInfo>(),
      get<_i14.CreateCategory>(),
      get<_i14.SaveCategories>()));
  gh.lazySingleton<_i29.CategoryDao>(
      () => _i29.CategoryDao(get<_i30.CategoriesDatabase>()));
  gh.lazySingleton<_i31.CategoryMapper>(() => _i31.CategoryMapper());
  gh.lazySingleton<_i32.CategoryRepository>(
      () => _i33.CategoryRepositoryImpl(get<_i26.CategoriesLocalDataSource>()));
  gh.factory<_i34.CreateAccount>(
      () => _i34.CreateAccount(get<_i6.AccountRepository>()));
  gh.factory<_i35.CreateBudget>(
      () => _i35.CreateBudget(get<_i19.BudgetRepository>()));
  gh.factory<_i36.CreateCategory>(
      () => _i36.CreateCategory(get<_i32.CategoryRepository>()));
  gh.factory<_i37.DeleteAccount>(
      () => _i37.DeleteAccount(get<_i6.AccountRepository>()));
  gh.factory<_i38.DeleteBudget>(
      () => _i38.DeleteBudget(get<_i19.BudgetRepository>()));
  gh.factory<_i39.DeleteCategory>(
      () => _i39.DeleteCategory(get<_i32.CategoryRepository>()));
  gh.factory<_i40.EditAccountScreenCubit>(() => _i40.EditAccountScreenCubit(
      get<_i11.UpdateAccount>(),
      get<_i11.DeleteAccount>(),
      get<_i12.GetProfileInfo>(),
      get<_i11.CreateAccount>()));
  gh.factory<_i41.EditBudgetScreenCubit>(() => _i41.EditBudgetScreenCubit(
  ...
  gh.factory<_i42.EditCategoryScreenCubit>(() => _i42.EditCategoryScreenCubit(
      ...
      get<_i14.CreateCategory>()));
  gh.factory<_i43.EditSubCategoryScreenCubit>(() =>
      _i43.EditSubCategoryScreenCubit(
          get<_i14.UpdateSubCategory>(), get<_i14.DeleteSubCategory>()));
  gh.factory<_i44.EditTransactionScreenCubit>(() =>
      _i44.EditTransactionScreenCubit(get<dynamic>(), get<dynamic>(),
          get<_i12.GetProfileInfo>(), get<dynamic>()));
  ...
  gh.factory<_i51.GetCategories>(
      () => _i51.GetCategories(get<_i32.CategoryRepository>()));
  ...
  gh.factory<_i61.SaveCategories>(
      () => _i61.SaveCategories(get<_i32.CategoryRepository>()));
  ...
  gh.lazySingleton<_i29.SubCategoryDao>(
      () => _i29.SubCategoryDao(get<_i30.CategoriesDatabase>()));
  gh.lazySingleton<_i64.SubCategoryMapper>(() => _i64.SubCategoryMapper());
  gh.lazySingleton<_i32.SubCategoryRepository>(() =>
      _i65.SubCategoryRepositoryImpl(get<_i26.CategoriesLocalDataSource>()));
  ...
  gh.factory<_i74.UpdateBudget>(() =>
      _i74.UpdateBudget(get<_i19.BudgetRepository>(), get<_i24.GetBudgets>()));
  gh.factory<_i75.UpdateCategory>(() => _i75.UpdateCategory(
      get<_i32.CategoryRepository>(), get<_i14.GetCategories>()));
  gh.factory<_i76.UpdateSubCategory>(() => _i76.UpdateSubCategory(
      get<_i32.SubCategoryRepository>(), get<_i14.GetSubCategories>()));
  gh.factory<_i77.UpdateTransaction>(() => _i77.UpdateTransaction(
      get<_i69.TransactionRepository>(), get<_i78.GetTransactions>()));
  ...
  gh.factory<_i84.CreateSubCategory>(
      () => _i84.CreateSubCategory(get<_i32.SubCategoryRepository>()));
  gh.factory<_i85.CreateUser>(() => _i85.CreateUser(get<_i81.AuthService>()));
  gh.factory<_i86.DeleteSubCategory>(
      () => _i86.DeleteSubCategory(get<_i32.SubCategoryRepository>()));
  ...
  gh.factory<_i89.GetSubCategories>(
      () => _i89.GetSubCategories(get<_i32.SubCategoryRepository>()));
  ...
  gh.factory<_i92.SaveSubCategories>(
      () => _i92.SaveSubCategories(get<_i32.SubCategoryRepository>()));
